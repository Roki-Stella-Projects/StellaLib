 ...
 */
import type { ManagerOptions } from "../Structures/Types";
...
export default function ManagerCheck(options: ManagerOptions): void {
	...
	const {
		autoPlay, clientId, clientName, defaultSearchPlatform,
		nodes, plugins, send, shards, trackPartial,
		usePriority, useNode, replaceYouTubeCredentials, caches,
	} = options;
	...
	if (typeof caches !== "undefined" && typeof caches !== "object")
		throw new TypeError('Manager option "caches" must be an object.');
